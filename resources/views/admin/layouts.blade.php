...
<div id="wrapper">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ asset('public/images/undraw_profile_1.svg') }}"
                                            alt="">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ asset('public/images/undraw_profile_2.svg') }}"
                                            alt="">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ asset('public/images/undraw_profile_3.svg') }}"
                                            alt="">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="logout-form" action="{{ route('post.admin.logout') }}" method="post">@csrf</form>
    ...
    <script src="{{ asset('js/sbadmin/sb-admin-2.min.js') }}"></script>
