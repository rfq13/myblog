...
@section('maps')
<li><a href="{{ route('blogs') }}" style="color: #444444">Blog</a></li>
...
@section('content')
    <div class="col-lg-8 entries">
        ...
        <div class="entry-meta">
            ...
            <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="blog-single.html"><time datetime="2020-01-01">{{ $post->modified }}</time></a></li>
