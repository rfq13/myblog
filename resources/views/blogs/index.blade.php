...
@section('content')
  <div class="col-lg-8 entries">
    ...
    <div class="row">
      @php
          $posts = \App\Models\Post::where(['show'=>1])->orderby('created_at','desc')->paginate(6);
      ...
      @foreach ($posts as $key => $post)
        <div class="col-md-6 d-flex align-items-stretch">
          <article class="entry">
            ...
            <div class="entry-img">
              <img src="{{ storedAsset($post->thumbnail) }}" alt="" class="img-fluid">
            </div>
            ...
            <div class="entry-meta">
              <ul>
                <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="{{ route('blog.detail',$post->slug) }}">John Doe</a></li>
                <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="{{ route('blog.detail',$post->slug) }}"><time datetime="2020-01-01">{{ $post->modified }}</time></a></li>
              </ul>
            </div>
